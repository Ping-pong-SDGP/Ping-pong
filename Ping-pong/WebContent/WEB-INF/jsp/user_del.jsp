...
<body>
  ...
  <div class="wrapper">
    ...
    <br><span style="padding-left:20px;">ホーム　＞　従業員の削除</span>
      ...
      <br><br>
      <div class="sort-area">
        <form action="/Ping-pong/SearchUser" method="post" style="margin-bottom:-20px;">
          <p style="font-size:20px;"><span class="fa fa-search" style="color:#3B5998;padding-right:5px;"></span>従業員検索</p>
          <div class="row">
            <div class="col-sm-4">
              <input type="search" name="userName" placeholder="検索するキーワードを入力してください" class="form-control">
            </div>
            <div class="col-sm-1">
      ...
      <div class="product-list">
		...
		<tr><td><%= user.getId() %></td><td><%= user.getName()%></td><td><%=permission %>
              ...
              <td>
                  ...
                  <form action="/Ping-pong/UserDel" method="post" style="padding:0px;">
                    <input type="submit" value="　削　除　" class="btn btn-danger">
                    <input type="hidden" name="userName" value=<%=user.getName() %>>
                    <input type="hidden" name="userId" value=<%=user.getId() %>>
                    <input type="hidden" name="permission" value=<%=user.getPermission()%>>
                  </form>
